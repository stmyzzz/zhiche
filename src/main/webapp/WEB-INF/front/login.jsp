...
<div id="content">
    <div id="content_login_select">
        ...
        <span class="chick" style="text-align: center;">登录</span>
    </div>
    ...
    $("#submit").click(function(){
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                if(result=='false'){
                	mdui.snackbar('账号密码不正确', {position: 'top', timeout: 1500});
                }else{
                	mdui.snackbar('未知错误，请联系管理员', {position: 'top', timeout: 1500});
                }
